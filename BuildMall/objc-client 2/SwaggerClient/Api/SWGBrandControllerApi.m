#import "SWGBrandControllerApi.h"
...
@interface SWGBrandControllerApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGBrandControllerApi

NSString* kSWGBrandControllerApiErrorDomain = @"SWGBrandControllerApiErrorDomain";
NSInteger kSWGBrandControllerApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) getBrandUsingDELETEWithAuthorization: (NSString*) authorization
    ...
    if (authorization == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGBrandControllerApiErrorDomain code:kSWGBrandControllerApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/brandTable/list"];
...
-(NSURLSessionTask*) insertBrandInfoUsingDELETEWithAuthorization: (NSString*) authorization
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/brandTable/insert"];
