#import "SWGCategoryControllerApi.h"
...
@interface SWGCategoryControllerApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGCategoryControllerApi

NSString* kSWGCategoryControllerApiErrorDomain = @"SWGCategoryControllerApiErrorDomain";
NSInteger kSWGCategoryControllerApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) boardPriceUpdateUsingDELETEWithAuthorization: (NSString*) authorization
    ...
    if (authorization == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGCategoryControllerApiErrorDomain code:kSWGCategoryControllerApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/category/boardPriceUpdate"];
    ...
    bodyParam = boardPriceUpdateList;
...
-(NSURLSessionTask*) categoryListUsingDELETEWithAuthorization: (NSString*) authorization
    ...
    if (categoryName == nil) {
        ...
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"categoryName"] };
            NSError* error = [NSError errorWithDomain:kSWGCategoryControllerApiErrorDomain code:kSWGCategoryControllerApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/category/list"];
...
-(NSURLSessionTask*) importCommodityInfoUsingDELETEWithAuthorization: (NSString*) authorization
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/category/importCommodityInfo"];
...
-(NSURLSessionTask*) importExcelCategoryUsingDELETEWithAuthorization: (NSString*) authorization
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/category/importCommodityInfoTwo"];
...
-(NSURLSessionTask*) insertCategoryUsingDELETEWithAuthorization: (NSString*) authorization
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/category/insertCategory"];
...
-(NSURLSessionTask*) showCategoryAllUsingDELETEWithAuthorization: (NSString*) authorization
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/category/mallCategoryTableList"];
