...
#import "BOSSInteractiveFollowCell.h"

@interface BOSSInteractiveFollowVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation BOSSInteractiveFollowVC
...
- (void)viewDidLoad {
    ...
    [_tableView registerNib:[UINib nibWithNibName:@"BOSSInteractiveFollowCell" bundle:nil] forCellReuseIdentifier:@"BOSSInteractiveFollowCell"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *identifier1 = @"BOSSInteractiveFollowCell";
    BOSSInteractiveFollowCell *cell1 = [_tableView dequeueReusableCellWithIdentifier:identifier1];
