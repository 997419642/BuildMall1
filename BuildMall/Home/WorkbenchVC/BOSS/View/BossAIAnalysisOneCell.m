...
@interface BossAIAnalysisOneCell ()<ChartViewDelegate, IChartAxisValueFormatter>



@end

@implementation BossAIAnalysisOneCell
...
-(void)setup
{
    ...
    leftImg.image = [UIImage imageNamed:@"icongood"];
    ...
    headImg.image = [UIImage imageNamed:@"iconcontact"];
    ...
    [nameLable mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(headImg.mas_right).offset(20);
        make.top.equalTo(topView).offset(15);
