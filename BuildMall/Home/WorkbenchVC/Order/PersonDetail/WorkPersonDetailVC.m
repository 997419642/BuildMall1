...
#import "PersonDetailAIVC.h"
#import "PersonDetailInteractiveVC.h"
#import "InfomationDetailVC.h"

@interface WorkPersonDetailVC ()
@property (weak, nonatomic) IBOutlet UIButton *leftBtn;

@property (weak, nonatomic) IBOutlet NSLayoutConstraint *venter;
...
@implementation WorkPersonDetailVC
...
- (void)viewDidLoad {
    ...
    _contentView.sd_layout.topEqualToView(self.view).offset(158).rightEqualToView(self.view).leftEqualToView(self.view).bottomEqualToView(self.view).offset(0);
...
- (IBAction)infomationDetailAction:(UIButton *)sender {
    InfomationDetailVC* VC  =[InfomationDetailVC new];
...
{
    PersonDetailInteractiveVC *vc1 = [[PersonDetailInteractiveVC alloc] init];
    vc1.view.tag = 0;
    [self addChildViewController:vc1];
    [_contentView addSubview:vc1.view];
    [self setVCLayout:vc1];
    self.currentVC = vc1;
    PersonDetailAIVC *vc2 = [PersonDetailAIVC new];
