...
#import "TitleResultVC.h"
#import "BasicNavigationController.h"

@interface TitleChoosePersonVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation TitleChoosePersonVC
...
- (void)viewDidLoad {
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0,44, screenW, screenH-4-44) style:UITableViewStylePlain];
...
- (IBAction)searchAction:(id)sender {
    ...
    TitleResultVC* VC = [TitleResultVC new];
    BasicNavigationController *navigationController =
