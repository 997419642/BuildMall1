...
#import "TitleSearchResultsVC.h"
#import "TitlePersonVC.h"

@interface TitleResultVC ()<UISearchBarDelegate>
...
@property (nonatomic, weak) TitleSearchResultsVC *searchSuggestionVC;


@end

@implementation TitleResultVC

- (TitleSearchResultsVC *)searchSuggestionVC
{
    if (!_searchSuggestionVC) {
        TitleSearchResultsVC *searchSuggestionVC = [[TitleSearchResultsVC alloc] initWithStyle:UITableViewStylePlain];
