...
@interface ChoosePersonResultVC ()<UISearchBarDelegate>
...
@property (nonatomic, weak) ChooseSearchResultsVC *searchSuggestionVC;


@end

@implementation ChoosePersonResultVC

- (ChooseSearchResultsVC *)searchSuggestionVC
{
    if (!_searchSuggestionVC) {
        ChooseSearchResultsVC *searchSuggestionVC = [[ChooseSearchResultsVC alloc] initWithStyle:UITableViewStylePlain];
