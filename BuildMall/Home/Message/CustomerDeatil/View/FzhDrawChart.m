...
//        layer.fillColor = zzRandomColor.CGColor;
        ...
        NSArray* colorArr = @[@"FD6019", @"FFA92E", @"0FD15D", @"D0433E", @"3EA5D0", @"3ED0C7", @"B7B514", @"874082", @"306A9C", @"CD8D38", @"9DD03E", @"B83ED0", @"D0593E", @"CEBC16", @"F06764", @"8180BA", @"7999D2", @"74A434", @"1D9BE4", @"E85365"];

        NSArray *smallArray = [colorArr subarrayWithRange:NSMakeRange(0, x_itemArr.count)];
        
        NSMutableArray* arr = [NSMutableArray arrayWithArray:smallArray];


        if (x_itemArr.count<20) {
            layer.fillColor = [UIColor colorWithHexString:arr[i]].CGColor;
        }else
        {
            layer.fillColor = zzRandomColor.CGColor;
